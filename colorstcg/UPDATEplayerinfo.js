...
*/
var pendingtrades = ["lotanemesis: thesea20, softspoken17", "unsorted:"];
...
*/
var highprioritydecks = "goths, ignihyde, evilmonk, mcmb, oneandtwo, ozeki, woe"; // "deckone, decktwo, deckthree..."
var allisodecks = "goths, ignihyde, evilmonk, mcmb, oneandtwo, ozeki, woe, bowties, constellation, iceheart, mononoke, peer, shoujomanga, aloupeeps, anti-hero, bluecorp, bookseller, chuu, courtesan, glassgame, heartbuns, kanda, loneliest, napgus, neofantasy, postoffice, silentboy, yaiba"; // "deckone, decktwo, deckthree..."
...
var additionalCurrentSketchpadPoints = 18;
...
var playername = "ARGOXI"; // colors tcg name
var headername = "ARGOXI"; // in case you want it to be different from player name
